    ...
    return (
        <>
                ...
                <div className="section-title">
                    <h4 className="mb-0">
                        <div className="ms-1 me-1 pl-0 d-flex">
                            ...
                            />
                            <Button className="ms-2" onClick={() => setShowCreateModal(true)}>
                                Add
                            </Button>
                        </div>
                    </h4>
            ...
            <CreateRuleModal
                ...
                hideFn={() => setShowCreateModal(false)}
                currentRulesResponse={rulesResponse}
                onSuccess={() => {
                    setRefresh(!refresh);
        ...
        >
            ...
            <Modal.Footer>
                <Button
                    ...
                    onClick={() => createRule(patternField.current.value)}
                    variant="success"
                >
                    Create
                </Button>
